...
OLS_MTCARS = ModelFixture(
    ...
    coefs=[
        CoefFixture("const", 37.22727012, 1.59878754, 23.2847964, 2.565e-20,  34.002e+0, 40.4526e+0),
        CoefFixture("hp",    -0.03177295,  0.00902971, -3.5190399, 1.782e-03, -0.0501e+0, -0.0134e+0),
        CoefFixture("wt",    -3.87783074,  0.63273151, -6.1290048, 1.126e-06, -5.1719e+0, -2.5838e+0),
    ],
